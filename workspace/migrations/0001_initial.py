# Generated by Django 2.0.5 on 2018-05-20 17:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_busy', models.CharField(default='0', max_length=256, validators=[django.core.validators.RegexValidator(re.compile('^\\d+(?:\\,\\d+)*\\Z'), code='invalid', message='Enter only digits separated by commas.')])),
