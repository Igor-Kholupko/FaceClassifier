...
from django.core.management.base import (
    CommandError, CommandParser, handle_default_options,
)
from django.utils import autoreload
from populatedb import populate_db
...
class FaceClassifierManagementUtility(ManagementUtility):
    ...
    def execute(self):
        ...
        # 'django-admin --importdirs' to pre-populate directories database.
            ...
            populate_db(settings.ROOT_DIRECTORY, settings.THUMBNAILS_DIRECTORIES, args[0] == '--check')
